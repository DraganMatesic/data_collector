"""BaseScraper class and app status update helper.
...
The update_app_status() free function writes runtime state back to the
Apps table and is called by the init() entry point before and after the
scraper runs.
"""
