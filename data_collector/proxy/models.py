...
def extract_root_domain(domain: str) -> str:
    ...
    edge cases like .gov.hr, .co.uk, .com.au correctly.

    Args:
        domain: Full domain string (e.g., "sub.gov.hr", "api.example.co.uk").

    Returns:
        Registered root domain (e.g., "gov.hr", "example.co.uk").
