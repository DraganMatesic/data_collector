...
class ProxyManager:
    ...
    Reservation uses root domain (e.g., "gov.hr") to prevent IP collision
    across all subdomains. Blacklist uses full subdomain (e.g., "sub.gov.hr")
    ...
    Args:
        ...
        target_domain: Full target domain including subdomain (e.g., "sub.gov.hr").
