...
See [50. roadmap.md](50.%20roadmap.md) for planned releases:
- **v0.2.0** — App Orchestration (Manager, Scheduler, Command Dispatch, Scaffold CLI)
- **v0.3.0** — Scraping Infrastructure (BaseScraper, Request, Proxy, Captcha, Threading)
- **v0.4.0** — Integration Features (SOAP/XML, PDF/OCR, Dramatiq, WatchService, Notifications, FunctionLog)
- **v0.5.0** — Advanced Features (NER Pipeline, Custom NER Training, Optional Airflow)
- **v1.0.0** — Platform Release (REST API, Dashboard, Authentication, Security, Docker)
