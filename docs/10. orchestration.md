...
python -m data_collector.scaffold create --group croatia --parent fina --name companies

# Enable app for scheduling (disable=False, clear fatal flags)
python -m data_collector.scaffold enable --group croatia --parent fina --name companies

# Disable app (disable=True, Manager stops scheduling)
python -m data_collector.scaffold disable --group croatia --parent fina --name companies

# Remove from Manager oversight (app_type=STANDALONE, disable=True)
python -m data_collector.scaffold unmanage --group croatia --parent fina --name companies

# Mark for removal with 30-day grace period (default)
python -m data_collector.scaffold remove --group croatia --parent fina --name companies

# Mark for removal with custom grace period
python -m data_collector.scaffold remove --group croatia --parent fina --name companies --grace-days 7
```
