...
```python
# apps/croatia/findata/bank_accounts/main.py
from data_collector.scraping import BaseScraper
from data_collector.utilities.hashing import bulk_hash
from apps.croatia.findata.bank_accounts.parser import Parser
from apps.croatia.findata.bank_accounts.tables import BankAccounts
...
| **Async SOAP** | `AsyncTransport(client=req.async_client)` — Phase 4, when Request class adds async httpx support |
