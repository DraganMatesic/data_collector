...
| Notification system | Pluggable alert channels — Telegram, Slack, Discord, email, webhooks |
...
- **Public repository access**: Viewing and forking are permitted only as GitHub platform mechanics.
- **No use rights without commercial license**: Running, testing, modifying for use, deploying, distributing, or commercial/business/client use is not permitted unless explicitly licensed in writing.
- **Licensed organizations**: Authorized employees and contractors may use licensed forks within signed commercial license scope.
- **Third-party delivery restriction**: Client delivery, redistribution, OEM, or service resale requires a separate signed addendum.
...
| Notifications | Telegram Bot API, Slack API, Discord webhooks, SMTP |
