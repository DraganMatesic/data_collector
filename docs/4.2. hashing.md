...
Defines the Unicode normalization form applied to string values before hashing. Planned module path: `data_collector/enums/hashing.py`.
...
**Hash a string:**
```python
hash_value = make_hash("croatia|findata|companies")
