...
The `Request` class (planned module path: `data_collector/utilities/request.py`) provides centralized HTTP operations based on httpx, supporting both synchronous and asynchronous methods:
