...
**Implementation Status:** PLANNED | **Work Package:** WP-13 | **Milestone:** v0.6.0
...
| Person names & roles | Court documents | "Director: John Smith" |
| Addresses | Registration documents | "Main Street 1, 10000 Example City" |
| Financial figures | Financial statements | "Revenue: EUR 1,234,567" |
| Dates & references | Legal documents | "TIN:12345678901, 15.01.2025" |
| Registration numbers | Government registries | "REG:080123456" |
...
OCR Text / Scraped HTML
   ...
   (routing key: e.g., "ocr.extracted.gazette")
         │
         ▼
...
```python
import dramatiq
from data_collector.pipeline.topics.country import NER_COMPANY_REGISTRATION
...
For multi-language support (regional languages), consider training custom models or using multilingual transformers.
