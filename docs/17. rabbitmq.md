...
| `queue` | `dc_manager` | Queue name for this manager |
| `prefetch` | `1` | Messages to prefetch |
| `heartbeat` | `600` | AMQP heartbeat interval in seconds |
| `connection_timeout` | `10` | Blocked connection timeout in seconds |
| `reconnect_max_attempts` | `5` | Maximum reconnection attempts |
| `reconnect_base_delay` | `1` | Base delay for exponential backoff (seconds) |
| `reconnect_max_delay` | `30` | Maximum reconnection delay cap (seconds) |
