...
```python
# Planned file path: data_collector/country/financials/company_data/tables.py
...
def collect_companies():
    ...
    log_service = LoggingService(
        logger_name="country.financials.company_data",
...
```bash
python -m data_collector.country.financials.company_data.main
```

Expected output:
```
2025-01-15 10:30:00 INFO country.financials.company_data Starting company collection
2025-01-15 10:30:00 INFO country.financials.company_data Collected 3 records from source
2025-01-15 10:30:01 INFO country.financials.company_data Merge complete: inserted=3, archived=0, total=3
```

Run again — zero inserts (data unchanged):
```
2025-01-15 10:31:00 INFO country.financials.company_data Merge complete: inserted=0, archived=0, total=3
```
