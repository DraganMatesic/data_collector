...
**Implementation Status:** IMPLEMENTED | **Work Package:** WP-05 | **Milestone:** v0.3.0
...
│  │                   │     │  app_id                   │  │
│  │  Implementations: │     │  reservation_date              │  │
...
class ProxyReservation(Base):
    ...
    reservation_date: Mapped[datetime] = mapped_column(DateTime)      # When reserved
    ...
    with self.database.create_session() as session:
        ...
        session.execute(
            ...
            .where(
                ...
                func.now() > ProxyReservation.reservation_date + ttl_interval
            )
